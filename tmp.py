...
if __name__ == "__main__":
    ...
    parser.add_argument('-original_dir',     type=str,     default='data',           help='path to original data folder')
    parser.add_argument('-original_name',    type=str,     default='ima',            help='original data name')
    parser.add_argument('-processed_dir',    type=str,     default='data',           help='path to processed data folder')
    parser.add_argument('-processed_name',   type=str,     default='ima',            help='processed data name')
    parser.add_argument('-output_dir',       type=str,     default='data',           help='path to output data folder')
    parser.add_argument('-output_name',      type=str,     default='ima',            help='output data name')
    ### other options
    parser.add_argument('-gpu',              type=int,     default=0,                help='gpu device id')
    parser.add_argument('-fstart',           type=int,     default=1,                help='first frame')
    parser.add_argument('-fend',             type=int,     default=100,              help='last frame')
    parser.add_argument('-iter',             type=int,     default=5,                help='smoothing iterations')
    ...
    ## frame 0
    frame_p1 = utils.read_img(os.path.join(opts.processed_dir, "%s.%04d.png" %(opts.processed_name, opts.fstart)))
    output_filename = os.path.join(opts.output_dir, "%s.%04d.png" %(opts.output_name, opts.fstart))
    ...
    for t in range(opts.fstart+1, opts.fend+1):
                
        ### load frames
        frame_i1 = utils.read_img(os.path.join(opts.original_dir,  "%s.%04d.png" %(opts.original_name , t - 1)))
        frame_i2 = utils.read_img(os.path.join(opts.original_dir,  "%s.%04d.png" %(opts.original_name , t)))
        frame_o1 = utils.read_img(os.path.join(opts.output_dir,    "%s.%04d.png" %(opts.output_name   , t - 1)))
        frame_p2 = utils.read_img(os.path.join(opts.processed_dir, "%s.%04d.png" %(opts.processed_name, t)))
        ...
        ### save output frame
        output_filename = os.path.join(opts.output_dir, "%s.%04d.png" %(opts.output_name, t))
